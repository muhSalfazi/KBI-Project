...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.tambah_master').click(function() {
            ...
            $.ajax({
                url: "ajx/tambah-master-suzuki.php",
                method: "POST",
        ...
        $('.edit_master').click(function() {
            var id_pendaftar = $(this).attr('data-id');
            $.ajax({
                url: "ajx/edit-master-suzuki.php",
                method: "POST",
                data: { id_pendaftar: id_pendaftar },
                dataType: "html",
                success: function(data) {
        ...
        $('.delete_master').click(function() {
            var id_pendaftar = $(this).attr('data-id');
            $.ajax({
                url: "ajx/delete-master-suzuki.php",
                method: "POST",
                data: { id_pendaftar: id_pendaftar },
                dataType: "html",
                success: function(data) {
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-building fa-fw"></i> Data Kanban SUZUKI</h1>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <a href="import_partssuzuki.php" class='btn btn-primary btn-sm'><i class='fa fa-download'></i>&ensp;Import Data Kanban</a>
        <br><br>
            ...
            <div class="panel-body">
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        <?php
                        $No = 0;
                        $QueryListMaterials = mysqli_query($mysqli, "SELECT * FROM masterpart_suzuki ORDER BY id DESC");
