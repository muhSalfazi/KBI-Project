...
if (isset($_SESSION['alert']) == '1') {
  ...
  echo "<script type='text/javascript'>
      $(document).ready(function() {
        ...
        function(){
          window.location.href = 'delivery_hino.php';
        });
      });
    </script>";
}
...
<div class="row">
  <!-- Title -->
  <div class="col-lg-12">
    <h1 class="page-header"><i class="fa fa-truck fa-fw"></i>Delivery HINO</h1>
  </div>
  <!-- End Title -->
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <a id="admin" href="import_delivery_hino.php" class='btn btn-primary btn-sm'>
        <i class='fa fa-download'></i>&ensp;Import Manifest
      </a>
      <!-- Tombol untuk export seluruh data manifest ke Excel -->
      <a id="exportButton" data-id="<?php echo $d['id']; ?>" href="export_all_delivery_hino.php" class="btn btn-success btn-sm">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          $totalQuery = "SELECT COUNT(*) AS total_count FROM tbl_deliveryhino";
          $todayQuery = "SELECT COUNT(id) AS datasekarang FROM tbl_deliveryhino WHERE SUBSTR(datetime_input,1,10) = SUBSTR(NOW(),1,10)";
...
<script type="text/javascript">
  ...
  function loadData(status = '') {
      $.ajax({
          url: 'ajx/view_delivery_hino.php',
          type: 'POST',
          data: { status: status },
