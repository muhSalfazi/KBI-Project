...
?> 
    ...
    <div class="row">
    	...
    	<!-- Title -->
      <div class="col-lg-12">
          <h1 class="page-header"><i class="fa fa-building fa-fw""></i> Part</h1>
      </div>
      <!-- End Title -->
      ...
      <a href="#">
      	<button style="width:150px;" data-toggle="modal" data-target="#ModalAdd" class="btn btn-primary"><i class="fa fa-plus"></i> Add Part</button>
      </a>
      <!-- End Button -->
            ...
            <div class="panel-body">
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
					      	...
					      	<?php
					      		$No = 0;
                    $IdRole = 0;
					      		$QueryListMaterials=mysqli_query($mysqli, "SELECT * FROM master_partadm ORDER BY invid DESC");
					...
					<td class="text-center">
                      <?php 
                        echo"<a class='btn btn-primary btn-xs' style='width:65px;' href='Part_Edit.php?ID=".$ResultQueryListMaterials['InvId']."'><i class='fa fa-edit'> Edit</i></a>"; 
                      ?> 

                      <a href="#" class="btn btn-danger btn-xs" style="width:65px;" onclick="confirm_modal('../pages/crud/Part_Delete.php?&ID=<?php echo  $ResultQueryListMaterials['InvId']; ?>');"><i class="fa fa-trash"> Delete</i></a>
      ...
      <div class="modal-dialog">
        <div class="modal-content" style="width:400px;">
          <div class="modal-header" style="padding:35px;">
            ...
            <center><h4 class="modal-title"><b>Create New Part</b></h4></center>
          </div>
              ...
              <div class="form-group">
                <label>Part</label>
                  <div class="input-group">
                    ...
                    <input name="invid" type="text" class="form-control" style="width:330px;" placeholder="Inv ID" required="" />
					<input name="partname" type="text" class="form-control" style="width:330px;" placeholder="Partname" required="" />
					<input name="partno" type="text" class="form-control" style="width:330px;" placeholder="Part No." required="" />
                  </div>
              </div>
