...
<div class="row">
  <!-- Title -->
  <div class="col-lg-12">
    <h1 class="page-header"><i class="fa fa-truck fa-fw"></i>Delivery ADM</h1>
  </div>
  <!-- End Title -->
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <a id="admin" href="https://delivery.jajaleun.com/tes/index-import-adm" class='btn btn-primary btn-sm'>
