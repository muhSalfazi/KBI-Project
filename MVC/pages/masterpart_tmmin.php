...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('.tambah_master').click(function() {
			...
			$.ajax({
				url: "ajx/tambah-master-tmmin.php",
				method: "POST",
				data: {
		...
		$('.delete_master').click(function() {
			...
			var id_pendaftar = $(this).attr('data-id');
			$.ajax({
				url: "ajx/delete-master-tmmin.php",
				method: "POST",
				data: {
					id_pendaftar: id_pendaftar
				},
...
<div class="row">
	<!-- Title -->
	<div class="col-lg-12">
		<h1 class="page-header"><i class="fa fa-building fa-fw""></i> Data Kanban TMMIN</h1>
      </div>
      <!-- End Title -->
      ...
      <div class=" row">
				<div class="col-lg-12">
					...
					<a href="import_partstmmin.php" class='btn btn-primary btn-sm'><i class='fa fa-download'></i>&ensp;Import Data Kanban</a>
					<br></br>
						...
						<div class="panel-body">
							...
							<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								<div class="container">
									...
									$No = 0;
									$IdRole = 0;
									$QueryListMaterials = mysqli_query($mysqli, "SELECT * FROM masterpart_tmmin ORDER BY id DESC");
