...
<div class="row">
	<!-- Title -->
	<div class="col-lg-12">
		<h1 class="page-header"><i class="fa fa-building fa-fw""></i> Data Kanban HPM</h1>
      </div>
      <!-- End Title -->
      ...
      <div class=" row">
				<div class="col-lg-12">
					...
					<a href="import_partshpm.php" class='btn btn-primary btn-sm'><i class='fa fa-download'></i>&ensp;Import Data Kanban</a>
					<br></br>
						...
						<div class="panel-body">
							...
							<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								<div class="container">
									...
									$No = 0;
									$IdRole = 0;
									$QueryListMaterials = mysqli_query($mysqli, "SELECT * FROM masterpart_hpm ORDER BY id DESC");
