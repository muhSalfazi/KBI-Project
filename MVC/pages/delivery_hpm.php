...
if (isset($_SESSION['alert']) == '1') {
  ...
  echo "<script type='text/javascript'>
      $(document).ready(function() {
        ...
        function(){
          window.location.href = 'delivery_hpm.php';
        });
      });
    </script>";
...
<div class="row">
  <!-- Title -->
  <div class="col-lg-12">
    <h1 class="page-header"><i class="fa fa-truck fa-fw"></i>Delivery HPM</h1>
  </div>
  <!-- End Title -->
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <a id="admin" href="https://delivery.jajaleun.com/tes/index-import" class='btn btn-primary btn-sm'>
        <i class='fa fa-download'></i>&ensp;Import Manifest
      </a>
      <!-- Tombol untuk export seluruh data manifest ke Excel -->
      <a id="exportButton" data-id="<?php echo $d['id']; ?>" href="export_all_delivery_hpm.php" class="btn btn-success btn-sm">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          $totalQuery = "SELECT COUNT(*) AS total_count FROM tbl_deliveryhpm";
          $todayQuery = "SELECT COUNT(id) AS datasekarang FROM tbl_deliveryhpm WHERE SUBSTR(datetime_input,1,10) = SUBSTR(NOW(),1,10)";
