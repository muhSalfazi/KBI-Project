...
?> 
    ...
    <div class="row">
    	...
    	<!-- Title -->
      <div class="col-lg-12">
          <h1 class="page-header"><i class="fa fa-building fa-fw""></i> Data Delivery Note</h1>
      </div>
      <!-- End Title -->
      ...
      <a href="#">
      	<button style="width:150px;" data-toggle="modal" data-target="#ModalAdd" class="btn btn-primary"><i class="fa fa-plus"></i> Add Delivery Order</button>
      </a>
      <!-- End Button -->
            ...
            <div class="panel-body">
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
					      	...
					      	<?php
					      		$No = 0;
                    $IdRole = 0;
					      		$QueryListMaterials=mysqli_query($mysqli, "SELECT * FROM tbl_deliverynote ORDER BY job_no DESC");
                    ...
                    <td class="text-center">
                      <?php 
                        echo"<a class='btn btn-primary btn-xs' style='width:65px;' href='deliveryorder_Edit.php?ID=".$ResultQueryListMaterials['job_no']."'><i class='fa fa-edit'> Edit</i></a>"; 
                      ?> 

                      <a href="#" class="btn btn-danger btn-xs" style="width:65px;" onclick="confirm_modal('../pages/crud/deliveryorder_Delete.php?&ID=<?php echo  $ResultQueryListMaterials['job_no']; ?>');"><i class="fa fa-trash"> Delete</i></a>
                    </td>
							    </tr>
  							  <?php 
  									} 
      ...
      <div class="modal-dialog">
        <div class="modal-content" style="width:400px;">
          <div class="modal-header" style="padding:35px;">
            ...
            <center><h4 class="modal-title"><b>Input New Delivery Note</b></h4></center>
          </div>
          <div class="modal-body">
            <form action="../pages/crud/Part_Add.php" name="modal_popup" enctype="multipart/form-data" method="post">
              <div class="form-group">
                <label>New Delivery Note</label>
                  <div class="input-group">
                    <div class="input-group-addon">
                      <i class="fa fa-paint-brush"></i>
                    </div>
                    <input name="dnno" type="text" class="form-control" style="width:330px;" placeholder="DN No." required="" />
					<input name="jobno" type="text" class="form-control" style="width:330px;" placeholder="Job No." required="" />
					<input name="customerpartno" type="text" class="form-control" style="width:330px;" placeholder="Customer Part No." required="" />
					<input name="qtypcs" type="text" class="form-control" style="width:330px;" placeholder="Quantity Pcs" required="" />
                  </div>
              </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content" style="margin-top:100px;">
            <div class="modal-header">
              ...
              <h4 class="modal-title" style="text-align:center;"> Are You Sure Delete This Part ?</h4>
            </div>
