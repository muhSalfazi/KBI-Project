	   ...
	   $(document).ready(function() {
		   var audio = new Audio('audio/3.mp3');
				...
				swal({ 
				  ...
				  function(){
					//window.location.href = 'masterpart_mmki.php';
				});
				});
</script>";
} else {
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('.tambah_master').click(function() {
			...
			$.ajax({
				url: "ajx/tambah-master-mmki.php",
				method: "POST",
				data: {
		...
		$('.delete_master').click(function() {
			...
			var id_pendaftar = $(this).attr('data-id');
			$.ajax({
				url: "ajx/delete-master-mmki.php",
				method: "POST",
				data: {
					id_pendaftar: id_pendaftar
				},
...
<div class="row">
	<!-- Title -->
	<div class="col-lg-12">
		<h1 class="page-header"><i class="fa fa-building fa-fw""></i> Data Kanban MMKI</h1>
      </div>
      <!-- End Title -->
      ...
      <div class=" row">
				<div class="col-lg-12">
					...
					<a href="import_partsmmki.php" class='btn btn-primary btn-sm'><i class='fa fa-download'></i>&ensp;Import Data Kanban</a>
					<br></br>
						...
						<div class="panel-body">
							...
							<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								<div class="container">
									...
									$No = 0;
									$IdRole = 0;
									$QueryListMaterials = mysqli_query($mysqli, "SELECT * FROM masterpart_mmki ORDER BY id DESC");
									...
									?>
										...
										<tr>
											...
											<td class="text-center">
												<a id="edit_master" class='edit_master btn btn-primary btn-xs' style='width:65px;' data-toggle="modal" data-target="#myModal" data-id="<?php echo  $ResultQueryListMaterials['InvId']; ?>"><i class='fa fa-edit'> Edit</i></a>
