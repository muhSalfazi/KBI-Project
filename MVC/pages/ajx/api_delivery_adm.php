<?php
// File: api_delivery_adm.php (Optimized)
...
$totalQuery = "SELECT COUNT(*) as total FROM tbl_deliveryadm a LEFT JOIN masterpart_adm b ON a.job_no = b.JobNo $whereSql";
...
while ($d = mysqli_fetch_assoc($result)) {
    $statusLabel = ($d['sequence_adm'] == $d['countp']) ? '<label style="color:red;">Close</label>' : '<label>' . $d['status'] . '</label>';
