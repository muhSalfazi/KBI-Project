...
<div class="panel-body">
	<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
		<div class="container">
			...
			$QueryListMaterials = mysqli_query($mysqli, "SELECT * FROM masterpart_mmki WHERE InvId='$part'");
	...
	<script type="text/javascript">
		$('#simpan-data').click(function() {
			...
			console.log(g);
			$.ajax({
				url: "ajx/tambah-proses-master-mmki.php",
				method: "POST",
				dataType: "json",
				data: {
					a: a,
			...
			window.location = ('masterpart_mmki.php');
