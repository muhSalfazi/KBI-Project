...
<div class="panel-body">
  <?php
  // Ambil data dari tabel tbl_deliveryadm berdasarkan dn_no
  $QueryListMaterials = mysqli_query($mysqli, "SELECT * FROM tbl_deliveryadm WHERE dn_no='$part'");
  ...
  <script type="text/javascript">
    $('#simpan-data').click(function() {
      ...
      $.ajax({
        url: "ajx/tambah-proses-delivery-adm.php",
        method: "POST",
        dataType: "json",
        data: {
          xx: xx,
        ...
        success: function(data) {
          console.log(data);
          // window.location = ('delivery_adm.php?page=ok');
        }
      });
      // Redirect ke halaman delivery_adm.php
      $("#modal-message").show(500);
      window.location = ('delivery_adm.php');
    });
