...
<div class="panel-body">
  <?php
  // Ambil data dari tabel tbl_deliverynote berdasarkan dn_no
  $QueryListMaterials = mysqli_query($mysqli, "SELECT * FROM tbl_deliverynote WHERE dn_no='$part'");
  ...
  <script type="text/javascript">
    $('#simpan-data').click(function() {
      ...
      $.ajax({
        url: "ajx/tambah-proses-delivery-mmki.php",
        method: "POST",
        dataType: "json",
        data: {
          xx: xx,
        ...
        success: function(data) {
          console.log(data);
          // window.location = ('delivery_mmki.php?page=ok');
        }
      });
      // Redirect ke halaman delivery_mmki.php
      $("#modal-message").show(500);
      window.location = ('delivery_mmki.php');
    });
