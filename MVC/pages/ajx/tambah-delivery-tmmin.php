...
<div class="panel-body">
  <?php
  // Ambil data dari tabel tbl_deliverytmmin berdasarkan dn_no
  $QueryListMaterials = mysqli_query($mysqli, "SELECT * FROM tbl_deliverytmmin WHERE dn_no='$part'");
  ...
  <script type="text/javascript">
    $('#simpan-data').click(function() {
      ...
      $.ajax({
        url: "ajx/tambah-proses-delivery-tmmin.php",
        method: "POST",
        dataType: "json",
        data: {
          xx: xx,
        ...
        success: function(data) {
          console.log(data);
          // window.location = ('delivery_tmmin.php?page=ok');
        }
      });
      // Redirect ke halaman delivery_tmmin.php
      $("#modal-message").show(500);
      window.location = ('delivery_tmmin.php');
    });
