...
<div class="panel-body"><?php //echo $_SESSION["id_role"].'xx';//echo $part;
  ...
  <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
    <div class="container">
      ...
      $QueryListMaterials = mysqli_query($mysqli, "SELECT * FROM tbl_eksporadm WHERE id='$part'");
      ...
      <tr>
        <td>Module No.</td>
        <td> :
        <td><input name="xxxx" value="<?php echo $ResultQueryListMaterials['module_no']; ?>"></td>
      </tr>
      <tr>
        <td>Qty Pcs.</td>
        <td> :
  ...
  <script type="text/javascript">
    $('#simpan-data').click(function() {
      ...
      var module_no = $("input[name=module_no]").val();
      ...
      console.log(triger);
      $.ajax({
        url: "ajx/edit-proses-export-adm.php",
        method: "POST",
        dataType: "json",
        data: {
          xx: xx,
