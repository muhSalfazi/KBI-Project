    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Delivery TMMIN</h4>
            </div>
...
$(document).ready(function() {
  var table = $('#example1').DataTable({
    ...
    processing: true,
    ajax: {
      url: 'ajx/api_delivery_tmmin.php',
      type: 'POST',
      data: function(d) {
  ...
  $(document).on('click', '.tambah_delivery', function () {
    $.ajax({
      url: 'ajx/tambah-delivery-tmmin.php',
      method: 'GET',
      dataType: 'html',
  ...
  $('#example1 tbody').on('click', '.edit_delivery', function() {
    ...
    $.ajax({
      url: "ajx/edit-delivery-tmmin.php",
      method: "POST",
  ...
  $('#example1 tbody').on('click', '.delete_delivery', function() {
    ...
    $.ajax({
      url: "ajx/delete-deliverytmmin.php",
      method: "POST",
      data: { id_pendaftar: id_pendaftar },
      dataType: "html",
      success: function(data) {
