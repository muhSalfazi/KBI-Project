    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Delivery MMKI</h4>
            </div>
...
$(document).ready(function() {
  ...
  $(document).on('click', '.tambah_delivery', function () {
    $.ajax({
      url: 'ajx/tambah-delivery-mmki.php',
      method: 'GET',
      dataType: 'html',
  ...
  $('#example1 tbody').on('click', '.edit_delivery', function() {
    ...
    $.ajax({
      url: "ajx/edit-delivery-mmki.php",
      method: "POST",
  ...
  $('#example1 tbody').on('click', '.delete_delivery', function() {
    ...
    $.ajax({
      url: "ajx/delete-deliverymmki.php",
      method: "POST",
      data: { id_pendaftar: id_pendaftar },
      dataType: "html",
      success: function(data) {
