...
<div class="panel-body">
	<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
		<div class="container">
			...
			$QueryListMaterials = mysqli_query($mysqli, "SELECT * FROM masterpart_suzuki WHERE InvId='$part'");
	...
	<script type="text/javascript">
		$('#simpan-data').click(function() {
			...
			console.log(g);
			$.ajax({
				url: "ajx/tambah-proses-master-suzuki.php",
				method: "POST",
				dataType: "json",
				data: {
					a: a,
			...
			window.location = ('masterpart_suzuki.php');
