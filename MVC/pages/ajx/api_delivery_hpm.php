<?php
// File: api_delivery_hpm.php (Optimized)
...
$totalQuery = "SELECT COUNT(*) as total FROM tbl_deliveryhpm a LEFT JOIN masterpart_hpm b ON a.job_no = b.JobNo $whereSql";
