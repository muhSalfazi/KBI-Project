...
<div class="row">
  <!-- Title -->
  <div class="col-lg-12">
    <h1 class="page-header"><i class="fa fa-truck fa-fw"></i>Delivery MMKI</h1>
  </div>
  <!-- End Title -->
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <a id="admin" href="import_delivery_mmki.php" class='btn btn-primary btn-sm'>
        <i class='fa fa-download'></i>&ensp;Import Manifest
      </a>
      <!-- Tombol untuk export seluruh data manifest ke Excel -->
      <a id="exportButton" data-id="<?php echo $d['id']; ?>" href="export_all_delivery_mmki.php" class="btn btn-success btn-sm">
...
<script type="text/javascript">
  ...
  function loadData(status = '') {
      $.ajax({
          url: 'ajx/view_delivery_mmki.php',
          type: 'POST',
          data: { status: status },
