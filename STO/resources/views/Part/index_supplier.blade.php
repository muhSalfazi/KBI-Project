    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title animate__animated animate__fadeInLeft">Data Part By Supplier</h5>
                        @if (Auth::user()->roles->pluck('name')->contains(function ($role) {
                            ...
                            <div class="mb-2 d-flex align-items-center">
                                ...
                                <a href="{{ route('part.export', ['category_id' => request('category_id'), 'export_type' => 'supplier']) }}"
                                    class="btn btn-warning btn-sm">
                                    <i class="bi bi-file-earmark-spreadsheet-fill"></i> Export Excel
                                </a>
                            </div>
                            <div class="mb-2">
                                <form action="{{ route('parts.index.supplier') }}" method="GET"
