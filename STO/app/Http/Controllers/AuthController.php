    ...
    public function userLogin(Request $request)
    {
        ...
        $validator = Validator::make(
            ...
            [
                ...
                'area_id' => 'required|exists:tbl_head_area,id', // Validasi area_id harus ada di tabel
            ],
            [
        ...
        if ($user) {
            ...
            session([
                'selected_area_id' => $request->area_id,
                'selected_area_name' => HeadArea::find($request->area_id)->nama_area ?? 'Unknown Area',
