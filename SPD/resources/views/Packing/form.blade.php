...
<body>
        ...
        <div class="card shadow-sm">
            <div class="card-body p-4">
                ...
                <div class="navbar-form d-flex justify-content-between align-items-center mb-1 p-1  rounded">
                    ...
                    <audio id="noOrderSound" src="{{ asset('assets/audio/error-170796.mp3') }}" preload="auto"></audio>
                    @if (session('notfound'))
                ...
                <div class="card p-4 shadow-lg" style="margin-bottom: -10px">
                    ...
                    <form class="row g-3" action="{{ route('packing.manage', Auth::id()) }}" method="POST"
                        ...
                        <div class="col-12 mb-2">
                            <label for="partNumberInput" class="form-label" style="font-size: 1.1rem;">Purchase Order
                                (Scan QR)</label>
            ...
            <div class="text-center">
                <img id="noDataImage" src="{{ asset('assets/img/scan-qr.png') }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Fungsi untuk alert dengan audio
            ...
            @elseif (session('notfound'))
                showAlertWithAudio('alertNotFound', 'noOrderSound');
            @endif
        });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            function showAlertWithAudio(alertId, audioId) {
                ...
                if (alertBox) {
                    ...
                    alertBox.classList.add('show'); // Menambahkan kelas show jika diperlukan
                }
                if (audio) {
