...
//validasi ID
	...
	$pdf->SetFont('TIMES','',7);
	$pdf->Cell(60,6,$ResultQuerySelectRFQ['revision_bom'],1,1); 

	$pdf->SetFont('TIMES','B',14);
	$pdf->Cell(100,7,'BILL OF MATERIAL',0,0,'C');

	$pdf->SetFont('TIMES','B',7);
	$pdf->Cell(31,6,'REVISION DATE',1,0);
	$pdf->SetFont('TIMES','',7);
	$pdf->Cell(60,6,$ResultQuerySelectRFQ['created_npd'],1,1); 
	...
	$FileName = date('dmYHis').'_'.'BILL_OF_MATERIAL'.'_'.$ResultQuerySelectRFQ['project_name'].'.pdf';
