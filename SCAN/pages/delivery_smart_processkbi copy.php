    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-9">
                                        <div class="input-field m-t-0 m-b-0">											
                                            <input type="text" id="textarea1" name = "kbndnkbi" placeholder="Scan Barcode" class="form-control
                                    border-0" autocomplete="off" autofocus required>
											<input type = "text" name = "job_no" value = "<?php echo $job_no ?>" >
											<input type = "text" name = "kbndn" value = "<?php echo $kbndn ?>" >
											<input type = "text" name = "dn" value = "<?php echo $dndrkbndn ?>" >
                                        </div>
                                    </div>
                                    <div class="col-3">
            ...
            <footer class="footer text-center">
                <a href="https://kyoraku.id">KBI teknologi-2021</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
